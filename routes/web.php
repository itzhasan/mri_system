...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/patients/{patient}/history', PatientHistory::class)
        ->name('patients.history')
        ->middleware('role:admin,doctor,mri_technician');
    Route::get('/patients/{patient}/history/pdf', [PatientHistoryController::class, 'pdf'])
    ...
    Route::get('/reports/{report}/print', [ReportPrintController::class, 'show'])
        ->name('reports.print')
        ->middleware('role:admin,doctor,mri_technician');
    Route::get('/reports/{report}/pdf', [ReportPrintController::class, 'pdf'])
        ->name('reports.pdf')
        ->middleware('role:admin,doctor,mri_technician');
